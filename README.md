...
Клонируйте репозиторий (необязательно): Если у вас есть код в репозитории Git (например, на GitHub), вы можете клонировать его на локальный компьютер:
git clone [repository_url]
cd [project_directory]


То есть, нужно обернуть команды git clone и cd в тройные обратные кавычки (```) и указать язык bash для подсветки синтаксиса.  Это сделает блок кода правильно отформатированным в Markdown.

Вот полный исправленный раздел "Установка" на русском языке:
